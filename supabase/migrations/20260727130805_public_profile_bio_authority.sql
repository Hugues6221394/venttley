-- Public profiles must source public bio/pronouns from the security-definer
-- summary RPC. Direct users-table reads are intentionally RLS constrained and
-- cannot be relied on when viewing another account.
